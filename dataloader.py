...
train_data = MyDataset(txt=os.path.join(root,'train_data.txt'), transform=data_tf_train) #data_tf_train
val_data = MyDataset(txt=os.path.join(root,'val_data.txt'), transform=data_tf_test)
